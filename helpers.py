...
from util import FeatureListNet, FeatureDictNet, FeatureHookNet, Conv2dSame
    ...
    for n, m in parent_module.named_modules():
        ...
        if isinstance(old_module, nn.Conv2d) or isinstance(old_module, Conv2dSame):
            ...
            if old_module.groups > 1:
                ...
                g = in_channels
            new_conv = conv(in_channels=in_channels, out_channels=out_channels, kernel_size=old_module.kernel_size,
